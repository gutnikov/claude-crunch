...
> **IMPORTANT:** The `/patrol` skill and E2E phase continuous monitoring require access to observability infrastructure via MCP servers.

### Required MCP Servers

| MCP Server       | Purpose             | Required For                                        |
| ---------------- | ------------------- | --------------------------------------------------- |
| Prometheus MCP   | Query metrics       | `/patrol --metrics`, E2E monitoring                 |
| Loki MCP         | Query logs          | `/patrol --logs`, E2E monitoring, log-analyst agent |
...
## Integration with /patrol and E2E
...
### How E2E Monitoring Works

During the 20-minute monitoring window in E2E phase:
