...
**File**: `.claude/knowledge/index.yaml`
...
content:
  ...
  related_incidents:
    - KE-incident-20250110-a1b2
    - KE-incident-20250112-c3d4
  last_successful: "2025-01-14T10:30:00Z"
```

## Agent Metrics Schema

Stored in index.yaml under `agent_metrics`. Used for adaptive routing and performance tracking.
