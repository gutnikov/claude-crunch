...
mcp__gitlab__create_issue(
    project_id: "{project_id}",
    title: "{issue title}",
    description: "{issue description with DOD}",
...
**DOD Requirement:** Every issue description MUST contain a "Definition of Done (DOD)" section. Each DOD item MUST have a verification method. See `templates/5-workflow.md` for full DOD format and examples.

**Example issue description with DOD:**
...
- [ ] Unit tests pass
  - **Verification:** Run `pytest tests/auth`, all tests pass
```
