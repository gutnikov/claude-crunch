---
name: review
description: Automated code review for pull requests. This skill is invoked automatically during the crunch workflow at the IMPLEMENTING → E2E transition. Domain-specific reviewers use this skill to perform thorough code review before staging deployment.
---
...
1. **Trigger**: IMPLEMENTING → E2E transition in `/crunch`
...
```
IMPLEMENTING ──► Code Review (this skill) ──► E2E
                     │
...
```
Context: /crunch 15 transitioning from IMPLEMENTING → E2E
...
6. Returns to crunch → proceeds to E2E
```
