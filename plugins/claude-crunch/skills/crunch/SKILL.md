...
1. **If `--target` provided**: use directly, skip to e2e
...
6. Executes: backlog -> enrich -> ready
   ...
   - Creates DoD checklist for staging e2e
...
4. Executes with security-focused agents:
   ...
   - E2E: security-analyst verifies fix
