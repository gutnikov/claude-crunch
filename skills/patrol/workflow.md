...
When used during `/crunch` VALIDATION phase for continuous monitoring:

### Activation

```
/crunch workflow reaches VALIDATION phase
...
### Anomaly Thresholds (VALIDATION mode)
